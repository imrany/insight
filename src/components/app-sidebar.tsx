...
export default function AppSidebar (){
  ...
  return (
    <div className={`sidebar bg-gradient-to-t from-blue-100/20 dark:from-blue-900/5 shadow-md shadow-gray-200 ${isOpen ? 'open ' : ''}`}>
        {isOpen?(
            <div className="pb-[20px] h-full pt-[10px] flex flex-col">
